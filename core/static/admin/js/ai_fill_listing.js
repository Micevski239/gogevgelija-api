(function ($) {
  ...
  var MODAL_HTML = [
    ...
    '<textarea id="ai-caption" rows="10" placeholder="Paste the social media post caption here…"',
  ...
  var BAR_HTML = [
    ...
    '<div style="font-size:12px;color:#9090b0;margin-top:2px;">Paste a social media caption to auto-fill title, description and tags in both languages</div>',
    '</div>',
  ...
  function fillForm(data) {
    ...
    setField("address_mk",     data.address_mk || "");
