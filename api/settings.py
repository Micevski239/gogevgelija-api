...
# enable storages if Spaces is used
...
# WhiteNoise only if not using Spaces
if not USE_SPACES:
...
DATABASES = {
    "default": dj_database_url.parse(
        db_url, conn_max_age=600, ssl_require=ssl_require, conn_health_checks=True
    )
}
...
# ---------------------------------------------------------------------
# Static / Media
# - If USE_SPACES=1: use DigitalOcean Spaces via django-storages
# - Else: local static with WhiteNoise
# ---------------------------------------------------------------------
if USE_SPACES:
    # required env:
    # AWS_ACCESS_KEY_ID
